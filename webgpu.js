const shadowMapCanvas = document.getElementById("shadow-map-canvas");
...
const positionPre = document.getElementById("position");
...
async function fetchShader(device, filename) {
